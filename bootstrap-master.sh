...
kubeadm init --pod-network-cidr=192.168.0.0/16 --apiserver-advertise-address="192.168.205.10" # add --apiserver-advertise-address="ip" if you want to use a different IP address than the main server IP
